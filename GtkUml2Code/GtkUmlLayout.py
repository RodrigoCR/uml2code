...
class GtkUmlLayout(gtk.Layout):
	...
	def add_new_class(self, class_name, super_class = None, outer_class = None):
		self.add_class(GtkUmlClassWidget(class_name), super_class, outer_class)
	...
	def add_class(self, widget, super_class = None, outer_class = None):
		...
		if(super_class != None):
			#widget.classSuperClass = super_class
